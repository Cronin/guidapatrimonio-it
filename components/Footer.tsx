      ...
      <div className="border-t border-white/10">
        <div className="container-custom py-6">
          <div className="flex flex-col md:flex-row justify-between items-center gap-4">
            ...
            <p className="text-body-sm text-white/50">
              <a href="tel:+393756448324" className="hover:text-white/70 transition-colors">+39 375 644 8324</a> | <a href="mailto:info@guidapatrimonio.it" className="hover:text-white/70 transition-colors">info@guidapatrimonio.it</a> | Via Monte Napoleone 28, 20121 Milano
            </p>
          </div>
        </div>
      </div>
