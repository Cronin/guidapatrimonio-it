      ...
      <div className="section-sm">
        <div className="container-custom">
          <div className="grid md:grid-cols-2 lg:grid-cols-5 gap-12">
            ...
            {/* Links Columns */}
            <div>
              <h4 className="font-body font-semibold text-body mb-4 text-gold">Strumenti</h4>
            ...
            <div>
              <h4 className="font-body font-semibold text-body mb-4 text-gold">Calcolatori</h4>
              <ul className="space-y-3">
            ...
            <div>
              <h4 className="font-body font-semibold text-body mb-4 text-gold">Info</h4>
              <ul className="space-y-3">
