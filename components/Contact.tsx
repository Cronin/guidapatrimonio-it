        ...
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-16">
          ...
          <div>
            ...
            <p className="text-body-lg text-gray-500 mb-8">
              Prenota una consulenza gratuita e senza impegno. Analizzeremo insieme
              la tua situazione e ti daremo un primo parere onesto.
            </p>
            ...
            <div className="space-y-6">
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <a href="mailto:info@guidapatrimonio.it" className="text-gray-500 hover:text-green-600 transition-colors">
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <a href="tel:+393331234567" className="text-gray-500 hover:text-green-600 transition-colors">
                    +39 333 123 4567
                  </a>
                </div>
              </div>
            ...
            <div className="mt-10 pt-8 border-t border-gray-200">
              <p className="text-sm text-gray-400 mb-4">Perché sceglierci</p>
