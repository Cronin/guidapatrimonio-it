      ...
      <div className="container-custom">
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-16">
          ...
          <div>
            ...
            <h2 className="font-heading text-h3-sm md:text-h3 text-navy mb-6">
            ...
            <div className="space-y-6">
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <a href="mailto:info@guidapatrimonio.it" className="text-gray-500 hover:text-gold transition-colors">
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  <p className="font-medium text-navy">Partner</p>
          ...
          <div className="bg-white rounded-card p-8 shadow-lg">
            <h3 className="font-heading text-xl text-navy mb-6">
