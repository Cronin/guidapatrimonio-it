  ...
  return (
    <main>
      ...
      <section className="relative pt-navbar overflow-hidden">
        {/* Background Image - Palazzo delle Finanze Roma */}
        <Image
          src="/images/finance/roma-palazzo-finanze.webp"
          alt="Architettura storica romana, simbolo della solidita patrimoniale"
          fill
          priority
